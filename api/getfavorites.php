...
<div id="ctl00_cphGoldblox_rbxFavoritesPane_NoResultsPanel" class="NoResults">
				    ...
				    <span id="ctl00_cphGoldblox_rbxFavoritesPane_NoResultsLabel" class="NoResults"><?php echo $_USERshit['username']; ?> has not chosen any favorite <?php echo $realtype2 ?>.</span>
